<script setup>
const page_title = 'Annales khâgne B/L : langue B portugais';

let meta_description = 'Les annales de langue B portugais pour les CPGE littéraires B/L.';
...
<template>
  <!-- app/pages/annales/cpge/khagne-bl/lb-portugais.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales khâgne B/L : langue B portugais
    </h1>

<script setup>
const page_title = 'Annales khâgne B/L : langue B espagnol';

let meta_description = 'Les annales de langue B espagnol pour les CPGE littéraires B/L.';
...
<template>
  <!-- app/pages/annales/cpge/khagne-bl/lb-espagnol.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales khâgne B/L : langue B espagnol
    </h1>

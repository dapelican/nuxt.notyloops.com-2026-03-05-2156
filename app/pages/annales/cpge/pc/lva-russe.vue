<script setup>
const page_title = 'Annales prépa PC : LVA russe';

let meta_description = 'Les annales de LVA russe pour les CPGE PC.';
...
const breadcrumb_items = [
  ...
  },
  {
    ...
    url: 'https://fr.notyloops.com/annales/cpge/pc/lva-russe',
  },
];
...
<template>
  <!-- app/pages/annales/cpge/pc/lva-russe.vue -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2026-ccs-rapport-russe-pc.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2025-ccs-rapport-russe-pc.pdf"
                target="_blank"
              >
                Rapport
              </ULink>

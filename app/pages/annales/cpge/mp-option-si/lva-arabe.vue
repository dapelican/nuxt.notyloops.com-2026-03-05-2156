<script setup>
const page_title = 'Annales prépa MP option SI : LVA arabe';

let meta_description = 'Les annales de LVA arabe pour les CPGE MP option SI.';
...
const breadcrumb_items = [
  ...
  },
  {
    ...
    url: 'https://fr.notyloops.com/annales/cpge/mp-option-si/lva-arabe',
  },
];
...
<template>
  <!-- app/pages/annales/cpge/mp-option-si/lva-arabe.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales CPGE MP option SI : LVA arabe
    </h1>

<script setup>
const page_title = 'Annales prépa MPI : LVA portugais';

let meta_description = 'Les annales de LVA portugais pour les CPGE MPI.';
...
const breadcrumb_items = [
  ...
  {
    label: 'LVA portugais',
    to: '/annales/cpge/mpi/lva-portugais',
    url: 'https://fr.notyloops.com/annales/cpge/mpi/lva-portugais',
  },
];
...
<template>
  <!-- app/pages/annales/cpge/mpi/lva-portugais.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales CPGE MPI : LVA portugais
    </h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2026-ccs-rapport-portugais-mpi.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2025-ccs-rapport-portugais-mpi.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-sujet-portugais.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-rapport-portugais.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
          ...
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccs-sujet-portugais.pdf"
                target="_blank"
              >
                Sujet
              </ULink>

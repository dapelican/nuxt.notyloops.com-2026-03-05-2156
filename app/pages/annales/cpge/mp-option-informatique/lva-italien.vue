<script setup>
const page_title = 'Annales prépa MP option informatique : LVA italien';

let meta_description = 'Les annales de LVA italien pour les CPGE MP option informatique.';
...
const breadcrumb_items = [
  ...
  {
    label: 'LVA italien',
    to: '/annales/cpge/mp-option-informatique/lva-italien',
    url: 'https://fr.notyloops.com/annales/cpge/mp-option-informatique/lva-italien',
  },
];
...
<template>
  <!-- app/pages/annales/cpge/mp-option-informatique/lva-italien.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales CPGE MP option informatique : LVA italien
    </h1>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-sujet-italien.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-rapport-italien.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
          ...
          <!-- <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccmp-sujet-italien.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccmp-rapport-italien.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
          ...
          <!-- <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccs-sujet-italien.pdf"
                target="_blank"
              >
                Sujet
              </ULink>

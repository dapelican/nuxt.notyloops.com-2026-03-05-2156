<script setup>
const page_title = 'Annales prépa MP option informatique : LVA russe';

let meta_description = 'Les annales de LVA russe pour les CPGE MP option informatique.';
...
const breadcrumb_items = [
  ...
  {
    label: 'LVA russe',
    to: '/annales/cpge/mp-option-informatique/lva-russe',
    url: 'https://fr.notyloops.com/annales/cpge/mp-option-informatique/lva-russe',
  },
];
...
<template>
  <!-- app/pages/annales/cpge/mp-option-informatique/lva-russe.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales CPGE MP option informatique : LVA russe
    </h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2026-ccs-rapport-russe-mp.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2025-ccs-rapport-russe-mp.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-sujet-russe.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccinp-e3a-polytech-rapport-russe.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
          ...
          <!-- <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccmp-sujet-russe.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccmp-rapport-russe.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
          ...
          <!-- <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccs-sujet-russe.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2024-ccs-rapport-mp-russe.pdf"
                target="_blank"
              >
                Rapport
              </ULink>

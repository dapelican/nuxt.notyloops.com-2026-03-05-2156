<script setup>
const page_title = 'Annales khâgne A/L classique : langue B espagnol';

let meta_description = 'Les annales de langue B espagnol pour les CPGE littéraires A/L classique.';
...
<template>
  <!-- app/pages/annales/cpge/khagne-al-classique/lb-espagnol.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales khâgne A/L classique : langue B espagnol
    </h1>

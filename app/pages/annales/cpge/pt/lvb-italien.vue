<script setup>
const page_title = 'Annales prépa PT : LVB italien';

let meta_description = 'Les annales de LVB italien pour les CPGE PT.';
...
<template>
  <!-- app/pages/annales/cpge/pt/lvb-italien.vue -->
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lvb-2026-pt-rapport-italien.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lvb-2025-pt-rapport-italien.pdf"
                target="_blank"
              >
                Rapport
              </ULink>

<script setup>
const page_title = 'Annales prépa PT : LVB anglais';

let meta_description = 'Les annales de LVB anglais pour les CPGE PT.';
...
<template>
  <!-- app/pages/annales/cpge/pt/lvb-anglais.vue -->
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lvb-2026-pt-rapport-anglais.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
          ...
          <tr>
            ...
            <td>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lvb-2025-pt-rapport-anglais.pdf"
                target="_blank"
              >
                Rapport
              </ULink>

...
<template>
  <!-- app/pages/annales/cpge/khagne-al-lsh/lve-allemand.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales khâgne A/L LSH : LVE allemand
    </h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/khagne-lve-2025-al-bel-sujet-allemand.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/khagne-lve-2025-al-bel-rapport-allemand.pdf"
                target="_blank"
              >
                Rapport
              </ULink>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/khagne-lve-2024-al-bel-sujet-allemand.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/khagne-lve-2024-al-bel-rapport-allemand.pdf"
                target="_blank"
              >
                Rapport
              </ULink>

<script setup>
const page_title = 'Annales khâgne A/L LSH : spécialité arts';

let meta_description = 'Les annales de l\'spécialité arts pour les CPGE littéraires A/L LSH.';
...
<template>
  <!-- app/pages/annales/cpge/khagne-al-lsh/specialite-arts.vue -->
  <UContainer class="max-w-xl">
    ...
    <h1>
      Annales khâgne A/L LSH : spécialité arts
    </h1>

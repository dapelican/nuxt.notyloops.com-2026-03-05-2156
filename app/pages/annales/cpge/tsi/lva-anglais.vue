<script setup>
const page_title = 'Annales prépa TSI : LVA anglais';

let meta_description = 'Les annales de LVA anglais pour les CPGE TSI.';
...
<template>
  <!-- app/pages/annales/cpge/tsi/lva-anglais.vue -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2026-tsi-ccs-sujet-anglais.pdf"
                target="_blank"
              >
                Sujet
              </ULink>
              ...
              <ULink
                class="text-primary"
                to="https://annales.notyloops.com/cpge-lva-2026-tsi-ccs-rapport-anglais.pdf"
                target="_blank"
              >
                Rapport
              </ULink> -->
